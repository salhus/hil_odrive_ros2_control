...
public:
    ...
    saturated_(false)
  {
    ...
    param_defs_ = {
      ...
      {"amplitude_rad_s",  15.0,  &VelocityPidNode::amplitude_rad_s_,  {},                                         false},
      {"omega_rad_s",       3.14, &VelocityPidNode::omega_rad_s_,      {},                                         false},
      {"kp",                0.03, &VelocityPidNode::kp_,               {},                                         true},
      {"ki",                0.1,  &VelocityPidNode::ki_,               {},                                         true},
      {"kd",                0.0,  &VelocityPidNode::kd_,               {},                                         true},
      {"kff",               0.015, &VelocityPidNode::kff_,             {},                                         false},
      {"kaff",              0.003, &VelocityPidNode::kaff_,            {},                                         false},
      ...
      {"filter_alpha",      0.7,  &VelocityPidNode::filter_alpha_,     unit_range_validator("filter_alpha"),       false},
